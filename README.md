...
| 09   | [```pseudo_cell_09_time_boxplot.py```](jupyter_snippets/pseudo_cell_09_time_boxplot.py)                                                                                                   | Displays conversion time distributions for both refactoring tasks per groups as single boxplot.                                                                                                                          |
