...
| 19   | [```pseudo_cell_19_participant_feedback.py```](jupyter_snippets/pseudo_cell_22_participant_feedback.py)                                                                                   | Produces a barchart on the participant feedback as extracted from the submitted forms.                                                                                                                                   |
