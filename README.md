...
| 15   | [```pseudo_cell_15_qualitytradeoff_by_app.py```](jupyter_snippets/pseudo_cell_15_qualitytradeoff_by_app.py)                                                                               | Produces Normal Distributions (see test in cell 08) for weighted conversion effectiveness all participants with same application and methodology.                                                                        |
