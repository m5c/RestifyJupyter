...
def plot_correlation(correlation: Correlation) -> None:
    ...
    plt.scatter(green_bundle.y_axis_values, green_bundle.x_axis_values, color=green_bundle.group_tint)
    ...
    plt.scatter(yellow_bundle.y_axis_values, yellow_bundle.x_axis_values, color=yellow_bundle.group_tint)
    plt.show()
