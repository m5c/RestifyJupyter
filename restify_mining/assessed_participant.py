...
class AssessedParticipant(Participant):
    ...
    def __init__(self, codename: str, skills: list[int], test_results_m: list[bool],
                 test_results_a: list[bool]):
        """
        :type self: object
        """
        ...
        self.__test_results_manual: list[bool] = test_results_m
        self.__test_results_assisted: list[bool] = test_results_a
